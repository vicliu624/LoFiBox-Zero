...
Assert-PathExists "src/runtime/creator_analysis_runtime.cpp" "Creator analysis runtime projection must live under src/runtime."
Assert-PathExists "src/runtime/runtime_event.cpp" "Runtime event stream semantics must live under src/runtime."
...
Assert-PathExists "src/tui/tui_app.cpp" "Terminal UI app coordinator must live under src/tui."
Assert-PathExists "src/tui/tui_renderer.cpp" "Terminal UI renderer must live under src/tui."
Assert-PathExists "src/tui/tui_input_router.cpp" "Terminal UI input router must live under src/tui."
Assert-PathExists "src/platform/tui/terminal_presenter.cpp" "Terminal presenter adapter must live under src/platform/tui."
Assert-PathExists "src/platform/tui/terminal_input.cpp" "Terminal input adapter must live under src/platform/tui."
