...
void drawFadedTextWindow(core::Canvas& canvas, std::string_view text, int x, int y, int width, int scroll_px, core::Color color)
{
    ...
    if (text_width <= width - 4) {
        ::lofibox::ui::drawText(source, text, source_width - text_width, 0, color, kScale);
    } else {
        const int cycle_width = text_width + 36;
        const int offset = scroll_px % cycle_width;
        ::lofibox::ui::drawText(source, text, -offset, 0, color, kScale);
        ::lofibox::ui::drawText(source, text, -offset + cycle_width, 0, color, kScale);
    }
...
void drawMainMenuTopbar(core::Canvas& canvas, const MainMenuView& view)
{
    ...
    ::lofibox::ui::drawText(canvas, "F1:HELP", 6, 6, ::lofibox::ui::kTextSecondary, 1);
...
void renderMainMenuPage(core::Canvas& canvas, const MainMenuView& view)
{
    ...
    ::lofibox::ui::drawText(canvas, ::lofibox::ui::fitUpper(kItems[static_cast<std::size_t>(left_index)], 10), 18, 120, ::lofibox::ui::kTextSecondary, 1);
    ...
    ::lofibox::ui::drawText(canvas, kItems[static_cast<std::size_t>(selected)], ::lofibox::ui::centeredX(kItems[static_cast<std::size_t>(selected)], 1), 126, ::lofibox::ui::kTextPrimary, 1);
    ...
    ::lofibox::ui::drawText(canvas, ::lofibox::ui::fitUpper(kItems[static_cast<std::size_t>(right_index)], 10), 206, 120, ::lofibox::ui::kTextSecondary, 1);
