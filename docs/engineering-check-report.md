...
- UI ownership status: page renderers, shared UI primitives, and UI projection structs now live under `src/ui`; `src/app` composes UI renderers and translates app/runtime/playback state into UI projections at the render boundary.
